...
namespace Unity.LEGO.Minifig
{
    ...
    public static class MinifigExploder
    {
        ...
        public static void CustomExplode(Minifig minifig, Transform leftArmTip, Transform rightArmTip, Transform leftLegTip, Transform rightLegTip, Transform head, Vector3 speed, float angularSpeed)
        {
            const float spreadForce = 6.0f;
            const float removeDelay = 3.0f;
